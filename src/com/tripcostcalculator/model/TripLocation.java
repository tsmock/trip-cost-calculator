...
public class TripLocation {
	...
	public double getDistance(double lat1, double lon1) {
		...
		distance = Math.acos(Math.sin(latitude) * Math.sin(lat2)
	 ...
	 * @param mpg The MPG of the vehicle to be used
	 ...
	 * @param costPerMile The cost per mile to use public transportation.
	 ...
	 * @param destination A string of the destination.
	 */
	public void setDestination(String destination)
	{
	    TripHashMap map = new TripHashMap();
	    String dest = map.addressMap(destination);
	    double lat = Double.parseDouble(dest.substring(0, dest.indexOf(",") - 1));
